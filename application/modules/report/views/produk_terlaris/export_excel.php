        ...
        <tbody>
            <?php if ( !empty($data) && count($data) > 0 ): ?>
                ...
                <?php foreach ($data as $k_data => $v_data): ?>
                    <tr class="search">
                        <td class="number_format"><?php echo angkaRibuan($no); ?></td>
                        ...
                        <td class="number_format"><?php echo angkaRibuan($v_data['qty']); ?></td>
                        <td class="decimal_number_format"><?php echo angkaDecimal($v_data['total']); ?></td>
                    </tr>
                    <?php $no++; ?>
                <?php endforeach ?>
            <?php else: ?>
            ...
            <?php if ( !empty($data) && count($data) > 0 ): ?>
                ...
                <?php foreach ($data as $k_member => $v_member): ?>
                    ...
                    <?php foreach ($v_member['detail_menu'] as $k_data => $v_data): ?>
                        <tr class="search">
                            <?php if ( $idx_member == 0 ): ?>
                                <td class="number_format" rowspan="<?php echo count($v_member['detail_menu'])+1; ?>"><?php echo angkaRibuan($no); ?></td>
                    ...
                    <tr>
                        ...
                        <td class="number_format"><b><?php echo angkaRibuan($t_jumlah); ?></b></td>
                        <td class="decimal_number_format"><b><?php echo angkaDecimal($t_total); ?></b></td>
                    </tr>
                    <?php $no++; ?>
                <?php endforeach ?>
            <?php else: ?>
