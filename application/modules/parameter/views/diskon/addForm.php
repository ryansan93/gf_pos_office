			...
			<table class="table no-border" style="margin-bottom: 0px;">
				<tbody>
					<tr>
						...
						<td class="col-sm-10">
							<input type="text" class="col-sm-8 form-control nama uppercase" placeholder="Nama Diskon" data-required="1">
						</td>
					</tr>
					<tr>
						<td class="col-sm-2">
					...
					<tr>
						...
						<td class="col-sm-10">
							<div class="col-sm-2 no-padding">
								<input type="text" class="col-sm-12 text-right form-control persen" placeholder="Persen" maxlength="6" data-tipe="decimal">
							</div>
					...
					<tr>
						...
						<td class="col-sm-10">
							<input type="text" class="col-sm-2 form-control text-right nilai" placeholder="Nilai" maxlength="10" data-tipe="decimal">
						</td>
					</tr>
					<tr>
						<td class="col-sm-2">				
						...
						<td class="col-sm-10 text-left">
							<input type="checkbox" class="non_member col-sm-1 cursor-p" style="height: 20px; margin: 0px; width: 3%;">
						</td>
					</tr>
					<tr>
						<td class="col-sm-2">				
						...
						<td class="col-sm-10 text-left">
							<input type="checkbox" class="member col-sm-1 cursor-p" style="height: 20px; margin: 0px; width: 3%;">
						</td>
					</tr>
					<tr>
						<td class="col-sm-2">				
						...
						<td class="col-sm-10">
							<input type="text" class="col-sm-2 form-control text-right min_beli" placeholder="Minimal Beli" maxlength="10" data-tipe="decimal">
						</td>
					</tr>
				</tbody>
			</table>
